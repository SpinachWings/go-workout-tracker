...
func GetRestrictions() Restrictions {
	return Restrictions{
		...
		TemplateSplitMaxDuration:            Restriction{3, 21, 99},
		TemplateWorkoutsPerUser:             Restriction{1, 21, 99},
		TemplateMaxExerciseGroupsPerWorkout: Restriction{4, 10, 99},
		...
		CalendarMaxExerciseGroupsPerWorkout: Restriction{8, 10, 99},
